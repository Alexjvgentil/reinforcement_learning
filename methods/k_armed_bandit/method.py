...
# Ambiente do Bandido de k-braços (k-Armed Bandit).
# Este ambiente simula k alavancas, onde cada uma possui um valor real q*(a) extraído de uma distribuição Normal(0, 1).
# Ao puxar uma alavanca (ação), o ambiente retorna uma recompensa extraída de uma distribuição Normal(q*(a), 1).
# O objetivo do agente é maximizar a soma das recompensas ao longo do tempo.
class BanditEnvironment:
    def __init__(self, k=10):
        self.k = k
        # True values of q*(a) for each arm, drawn from N(0,1)
...
if __name__ == "__main__":
    ...
    plt.title('Performance of K-Armed Bandit Algorithms')
    plt.legend()
    ...
    output_file = 'bandit_comparison.png'
    plt.tight_layout()
